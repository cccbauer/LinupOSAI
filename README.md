...
- 🤖 **AI Enhancements**: Machine learning-powered betting recommendations (planned)
...
- 🔄 **Multiple Progression Modes**: Fibonacci and Martingale strategies with AI optimization
...
- Python 3.9+
- Flet (Flutter for Python) v0.28.3
- SQLite3
- AI/ML frameworks (planned)
